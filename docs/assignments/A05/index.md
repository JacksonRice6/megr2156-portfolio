...
Starting with part A, which is a cylinder, I needed to determine its radius. For the length I assumed 1 inch, really it just needed to be bigger than the width of the strap. I used the equation: r = $\sqrt[3]{\frac{4Z}{\pi}}$
